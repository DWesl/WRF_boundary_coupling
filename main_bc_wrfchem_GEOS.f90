program main_bc_wrfchem
  ...
  !     boundary conditions tendencies
  ...
  !      (will create boundary variables for this tracer in wrfbdy if necessary)
  ...
  if(chem_bc_opt == 1) then
     ...
     call init_GEOS_lib( fng, ptop_wrf, xlon, xlat, znu, nx, ny, nz, day_start, hour_start, gincr )
